            ...
            <div id="print_section" class="card-body">
                ...
                <div class="row d-print-none">
                    <div class="col-sm-8 mt-3">
                        <form action="{{route('order.payment.create',$sale)}}" method="POST">
                            @csrf
                            <label for="" class="w-100">Payment</label>
                            <div class="ic-payment-method d-flex">
                                <div class="payment-method me-1">
                                    <input type="radio" value="cash" id="cash" name="payment_type" class="payment_type_input" checked="checked">
                            ...
                            <div class="form-group">
                                ...
                                <div class="ic-copy-url">
                                    <div class="input-group mb-3">
                                        <input name="total_paid" type="number" min="1" step="any" required class="form-control payment_amount" value="{{ $sale->total - $sale->total_paid }}">
                            ...
                            <div id="bank-info">
                                {{-- <div class="form-group">
                                    ...
                                    <input type="text" name="bank_info['account_no']" class="form-control">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="">Transaction No</label>
                                    <input type="text" name="bank_info['transaction_no']" class="form-control">
                                </div>
                                <div class="form-group mt-3 mb-3">
                                    <label for="">Transaction Date</label>
                                    <input type="date" name="bank_info['date']" class="form-control ">
                                </div> --}}
                            </div>
...
<script>
    $(document).ready(function() {
        let total_due_amount = "{{$sale->total - $sale->total_paid}}"
