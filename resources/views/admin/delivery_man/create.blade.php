...
<div class="col-lg-12 p-0">
    <div class="card">
        <div class="card-body">
            {{-- <h4 class="header-title">{{ __('Add Delivery Man') }}</h4> --}}
            <form action="{{ route('delivery-mans.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <div class="ic-form-group position-relative">
                            <select class="form-control" name="delivery_men[vehicle_type]">
                                ...
                                <option value="{{$type}}" {{old('vehicle_type') == $type ? 'selected' : ''}}>{{$type}}
                                </option>
                                @endforeach
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <div class="ic-form-group position-relative">
                            <input type="text" class="f-input form-control" name="delivery_men[vehicle_number]">
                        </div>
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <div class="ic-form-group position-relative">
                            <input type="text" class="f-input form-control" name="delivery_men[nid_no]">
                        </div>
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <div class="ic-form-group position-relative">
                            <input type="file" class="f-input form-control" name="delivery_men[nid_front]"
                                accept="image/*">
                        </div>
                    ...
                    <div class="form-group col-xl-4 col-lg-6 p-2">
                        ...
                        <div class="ic-form-group position-relative">
                            <input type="file" class="f-input form-control" name="delivery_men[nid_back]"
                                accept="image/*">
                        </div>
